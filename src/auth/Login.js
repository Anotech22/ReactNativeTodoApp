    ...
    <View style={styles.mainView}>
            ...
            <View style = {styles.loginWithView}>
                ...
                <TouchableOpacity>
                    <View style = {styles.imgTextView}> 
                        ...
                        <Text style={{color:'white', marginLeft:10 }}>Login with Google</Text>
                    </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity>
                    <View style = {{...styles.imgTextView, marginTop: 28}}> 
                        ...
                        <Text style={{color:'white', marginLeft:10 }}>Login with Apple</Text>
                    </View>
                </TouchableOpacity>
            </View>
            {/* Already have an account? */}
                <View style={styles.alreadyHaveAccountView}>
                    ...
                    >
                        <Text style={{color:'white', marginLeft:10, fontWeight:'bold', fontSize:16}}>Register</Text>
                    </Pressable>
                </View>
        </View>
  )
